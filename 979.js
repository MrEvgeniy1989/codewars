function driver(data) {
  ...
  const dec = dob.getYear().toString().length === 2 ? dob.getYear().toString()[0] : dob.getYear().toString()[1] // 1
  const month = data[4] === "M" ? ("0" + (dob.getMonth() + 1).toString()).slice(-2) : dob.getMonth() + 51
